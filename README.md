...
一個功能完整的線上訂房管理系統，提供住宿搜尋、預訂、管理等完整功能。
...
| 角色 | 帳號 | 密碼 | 權限 |
|------|------|------|------|
| 管理員 | `admin` | `password` | 完整系統管理權限 |
| 房東 1 | `owner1` | `123456` | 管理自己的住宿與訂單 |
| 房東 2 | `owner2` | `123456` | 管理自己的住宿與訂單 |
| 用戶 1 | `user1` | `123456` | 查詢、預訂、收藏功能 |
| 用戶 2 | `user2` | `123456` | 查詢、預訂、收藏功能 |
| 用戶 3 | `user3` | `123456` | 查詢、預訂、收藏功能 |
